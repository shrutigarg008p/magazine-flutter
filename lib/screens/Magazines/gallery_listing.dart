...
class Gallerylisting extends StatefulWidget {
  @override
  _GallerylistingState createState() => _GallerylistingState();
}

class _GallerylistingState extends State<Gallerylisting> {
  ...
  Widget magazineGrid() {
    return Container(
      ...
      child: GridView.builder(
        ...
        itemCount: galleryListingResponse['DATA']['data'].length,
              ...
              child: Column(
                ...
                children: [
                  Image(
                    ...
                    image: NetworkImage(galleryListingResponse['DATA']['data']
                        [index]['image']),
                    fit: BoxFit.fill,
                  ),
                  Text(
                    galleryListingResponse['DATA']['data'][index]['title']??"",
                    style: TextStyle(
                      fontSize: 14.0,
                      fontWeight: FontWeight.w600,
                    ),
                  ...
                  // Expanded(
                  //   child: Text(
                  //     galleryListingResponse['DATA']['data'][index]['price'],
                  //     style: TextStyle(
                  //       color: Colors.grey,
                  //       fontSize: 14.0,
                  //       fontWeight: FontWeight.w400,
  ...
  Map<String, dynamic> galleryListingResponse = Map();

  Future _getDataForMagazineListingPage() async {
    String baseurl = "http://gcgl.dci.in/public/api/";
    String parameterurl = "customer/gallery";

    var response = await http.get(Uri.parse(baseurl + parameterurl), headers: {
      'Authorization':
          'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC8xMjcuMC4wLjE6ODAwMFwvYXBpXC9hdXRoXC9sb2dpbiIsImlhdCI6MTYzMTY4ODI2MiwiZXhwIjoxNjM0MzE2MjYyLCJuYmYiOjE2MzE2ODgyNjIsImp0aSI6Im4xeWlTMUFheDVsUjRHZWoiLCJzdWIiOjUsInBydiI6IjIzYmQ1Yzg5NDlmNjAwYWRiMzllNzAxYzQwMDg3MmRiN2E1OTc2ZjcifQ.oztt1LF0s_QR0cbUi02ero40S52hTVggoz81szD8K34',
      'Content-type': 'application/json',
      'Accept': 'application/json',
    });

    galleryListingResponse = json.decode(response.body);
    if (galleryListingResponse['STATUS'] == 200) {
      print('data fetched successfully');
      //   print(magazineDetailResponse.toString());
    } else
      print(galleryListingResponse['MESSAGE']);
  }
}
