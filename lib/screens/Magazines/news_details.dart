...
import 'package:graphics_news/screens/Magazines/web_view.dart';
...
class _NewsDetailsState extends State<NewsDetails> {
  ...
  void initState() {
    ...
    super.initState();
    myFuture = Future.wait([_getDataForNewspaperDetailPage(), getSharedPref()]);
    myFuturePDf =
      ...
      return Scaffold(
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () => Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      WebViewContainer("http://gcgl.dci.in/public/api/customer/newspapers/flip_pdf/2"))),
        ),
        key: scaffoldKey,
        appBar: AppBar(
  ...
  Future _getDataForNewspaperDetailPage() async {
    String baseurl = "http://gcgl.dci.in/public/api/";
    String parameterurl = "customer/newspapers/${widget.newsId}/view";
  ...
  Future _getDataForNewspaperPDPEPUBPage() async {
    String baseurl = "http://gcgl.dci.in/public/api/";
    String parameterurl = "customer/newspapers/${widget.newsId}/pdf";
