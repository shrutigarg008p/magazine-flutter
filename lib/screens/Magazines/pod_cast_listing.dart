...
class _PodcastlistingState extends State<Podcastlisting> {
  ...
  Widget magazineGrid() {
    return Container(
      ...
      child: GridView.builder(
        ...
        itemCount: podCastListingResponse['DATA']['data'].length,
                    ...
                    children: [
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: Image(
                                ...
                                height: 62.0,
                                image: NetworkImage(
                                    podCastListingResponse['DATA']['data']
                      ...
                      Expanded(
                        child: Container(
                          // width: 50.0,
                          child: Text(
                            podCastListingResponse['DATA']['data'][index]
                                ['title'],
                            style: TextStyle(
                                fontSize: mediaQueryData.orientation ==
                                            Orientation.landscape &&
  ...
  Map<String, dynamic> podCastListingResponse = Map();

  getAudio(int index) async {
    _onSelected(index);
    var audioUrl =
        podCastListingResponse['DATA']['data'][index]['podcast_file'];
    print(audioUrl);
  ...
  Future _getDataForMagazineListingPage() async {
    ...
    String parameterurl = "customer/podcasts";
    ...
    podCastListingResponse = json.decode(response.body);
    if (podCastListingResponse['STATUS'] == 200) {
      print('data fetched successfully');
      //   print(magazineDetailResponse.toString());
    } else
      print(podCastListingResponse['MESSAGE']);
  }
}
