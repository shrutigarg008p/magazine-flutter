...
class CategoriesDetails extends StatefulWidget {
  ...
  const CategoriesDetails({Key? key, this.categoryId, this.categoryName})
      : super(key: key);
...
class _CategoriesDetailsState extends State<CategoriesDetails> {
  ...
  Future _getDataForMagazineListingPage() async {
    ...
    String parameterurl =
        "customer/category/${widget.categoryId}/popular_categories_details";
