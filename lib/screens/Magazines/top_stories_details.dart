...
class TopStoriesdetails extends StatefulWidget {
  ...
  const TopStoriesdetails({Key? key, this.magazineId}) : super(key: key);
...
class _TopStoriesdetailsState extends State<TopStoriesdetails> {
          ...
          Expanded(
            child: Container(
              child: AspectRatio(
                ...
                child: Image(
                  image: NetworkImage(storiesDetailResponse['DATA']
                      ['promoted_content']['content_image']),
                  fit: BoxFit.fill,
                ),
              ),
            ),
  ...
  Widget textContainer() {
    return Column(
      children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              storiesDetailResponse['DATA']['promoted_content']
                                  ['title'],
                              style: TextStyle(
        ...
        //       Expanded(
        //         child: Text(
        //           storiesDetailResponse['DATA']['promoted_content']['content'],
        //           style: TextStyle(
        //             fontSize: 14.0,
        //             fontWeight: FontWeight.w400,
        //           ),
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: List.generate(
                      storiesDetailResponse['DATA']['related'].length, (index) {
                    return InkWell(
                      child: Padding(
                        padding: const EdgeInsets.only(right: 8.0),
                        child: Column(
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: Image(
                                ...
                                height: 158.0,
                                image: NetworkImage(
                                    storiesDetailResponse['DATA']['related']
                                        [index]['cover_image']),
                                fit: BoxFit.fill,
                              ),
                            ),
                            ...
                            Text(
                              storiesDetailResponse['DATA']['related'][index]
                                  ['title'],
                              style: TextStyle(
          ...
          Expanded(
            child: Container(
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: List.generate(
                      storiesDetailResponse['DATA']['top_stories'].length,
                      (index) {
                    return Container(
                      width: 234.0,
                      child: Card(
  ...
  Map<String, dynamic> storiesDetailResponse = Map();

  Future _getDataForMagazineDetailPage() async {
    String baseurl = "http://gcgl.dci.in/public/api/";
    String parameterurl = "customer/blogs/top_story/${widget.magazineId}/view";
    ...
    storiesDetailResponse = json.decode(response.body);
    if (storiesDetailResponse['STATUS'] == 200) {
      print('data fetched successfully');
      //   print(magazineDetailResponse.toString());
    } else
      print(storiesDetailResponse['MESSAGE']);
  }
}
