...
class _VideoslistingState extends State<Videoslisting> {
  ...
  Widget magazineGrid() {
    return Container(
      ...
      child: GridView.builder(
        ...
        itemCount: videosListingResponse['DATA']['data'].length,
        itemBuilder: (context, index) => Padding(
          padding: const EdgeInsets.only(top: 0.0, bottom: 0.0, left: 20),
          child: Container(
            height: 100.0,
            width: 148.0,
            child: InkWell(
              onTap: () {
                setState(() {
                  playVideo = true;
                  videoId = videosListingResponse['DATA']['data'][index]
                          ["video_link"]
                      .split("=")
                      .last;
                });
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image(
                              //height: 112.0,
                              width: 148.0,
                              image: NetworkImage(videosListingResponse['DATA']
                    ...
                    Text(
                      videosListingResponse['DATA']['data'][index]['title'],
                      style: TextStyle(
                          fontWeight: FontWeight.w600,
                          fontSize: mediaQueryData.orientation ==
                                      Orientation.landscape &&
  ...
  Future _getDataForMagazineListingPage() async {
    ...
    videosListingResponse = json.decode(response.body);
    if (videosListingResponse['STATUS'] == 200) {
      print('data fetched successfully');
      //   print(magazineDetailResponse.toString());
    } else
      print(videosListingResponse['MESSAGE']);
  }
}
